...
void main() async {
  ...
  for (var page in pages) {
    if (page['page_number'] == 177) {
      ...
      // Move the last TWO words
      String word2 = words9.removeLast(); // ﱿ
      String word1 = words9.removeLast(); // ﱾ
      
      line9['text'] = words9.join(' ');
      line10['text'] = word1 + ' ' + word2 + ' ' + text10;
  ...
  print('Done modifying json with two words.');
}
